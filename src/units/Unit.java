...
public abstract class Unit {
	...
	public String name; 			//Villager, Hussar, Town Center, etc.
	public int id;					//Unit ID;
	public String civilization; 	//Spanish, Turks, etc.
	public String owner;			//Player username
	public int hitpoints;		//Health
	public String unitType;		//Infantry, Cavalry, archer, building, etc. - To calculate attack bonuses
	...
	public boolean isMilitary;	//Bool value to determine if unit is military unit
	...
	public int rangeMin;		//Minimum range of attack (0 for no minimum range, e.g. Throwing Axeman)
	...
	public boolean isGarrisoned=false;	//Is the current unit garrisoned or not
	public boolean isUnderAttack=false;	//To determine if unit is currently under attack
	public boolean isAttacking=false;	//To determine if unit is currently attacking
