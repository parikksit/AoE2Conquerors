...
public class Retriever {
	...
	public Retriever(String civName, InputStream in, String tagName, String logTag) {
		InputStream is = in;
		localLogTag = logTag;
		this.tagName = tagName;
		Log.i("Parikksit", "Just inside Retrieve "+logTag);
		try {
			Log.i(localLogTag, "Inside Try ");
		...
		public void startElement(String uri, String localName,String qName, 
			...
			Log.i(localLogTag, "Inside startElement "+qName);
